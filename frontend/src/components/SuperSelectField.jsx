...
class SelectField extends Component {
  ...
  handleMenuSelection = (selectedItem) => (event) => {
    ...
    if(!this.isValueSelected(selectedItem.value) && this.props.disableCallback()) return
  ...
  render () {
    const { children, hintText, hintTextAutocomplete, noMatchFound, multiple, disabled, nb2show,
      ...
      checkedIcon, unCheckedIcon, hoverColor, checkPosition, disableCallback
    } = this.props
    ...
    const menuItemBuilder = (nodes, child, index) => {
      ...
      return [ ...nodes, (
        <ListItem
          ...
          primaryText={child}
          hoverColor={
              !this.isValueSelected(childValue) && disableCallback() ?
              '#fff' : mergedHoverColor }
          innerDivStyle={{
            paddingTop: 10,
            paddingBottom: 10,
          ...
          style={
              !this.isValueSelected(childValue) && disableCallback() ?
              Object.assign({}, mergedSelectedMenuItemStyle, {backgroundColor:'#DDD'})
              : mergedSelectedMenuItemStyle
          }
        />)]
    }
...
SelectField.defaultProps = {
  ...
  value: null,
  onChange: () => {},
  onItemSelected: Function.prototype,
  children: []
}
